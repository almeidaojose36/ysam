                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-3 gap-6">
                                {stats.map((stat, index) => (
                                    <motion.div
                                        ...
                                        className="relative p-7 rounded-2xl bg-white/5 border border-white/10 hover:border-[var(--gold)]/50 transition-all group min-h-[160px] flex flex-col justify-center"
                                    >
                                        <div className="absolute top-0 right-0 w-24 h-24 bg-[var(--gold)]/5 rounded-full blur-3xl group-hover:bg-[var(--gold)]/10 transition-colors pointer-events-none" />
                                        <stat.icon className="w-5 h-5 text-[var(--gold)] mb-4" />
                                        <div className="flex flex-col">
                                            <span className="text-3xl font-bold text-white mb-1">{stat.value}</span>
                                            <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--gold)] mb-1 leading-tight">{stat.label}</span>
                                            <span className="text-[9px] text-white/40 uppercase tracking-normal leading-relaxed">{stat.sub}</span>
                                        </div>
                                    </motion.div>
                                ))}
                            </div>
